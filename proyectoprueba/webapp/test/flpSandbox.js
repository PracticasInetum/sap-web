		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#proyectoprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"proyectoprueba-display": {
								"semanticObject": "proyectoprueba",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=proyectoprueba",
									"url": sap.ui.require.toUrl("proyectoprueba")
								}
							}
						}
					}
